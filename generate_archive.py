...
from pylib.config import (
    ...
    ARCHIVE_TITLE, ARCHIVE_META_DESC, WORDS_ARCHIVE_FILE
)
...
def generate_archive_html(posts):
    ...
    html_parts.append(html_head(ARCHIVE_TITLE, extra_scripts=[TAG_FILTER_SCRIPT], meta_description=ARCHIVE_META_DESC, canonical_path='/words/'))
